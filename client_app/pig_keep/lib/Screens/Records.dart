...
// class _RecordsState extends State<Records> {
//   int? _selectedChoiceIndex = 0;
//   Map<String, String>? _selectedPig;
...
//   void _onRowSelected(Map<String, String> pig) {
//     setState(() {
//       _selectedPig = pig;
//       _selectedChoiceIndex = 0; // Switch to PigList when a pig is selected
//     });
//   }
...
//                       PigList(selectedPig: _selectedPig), // Pass selected pig
//                     if (_selectedChoiceIndex == 1)
//                       FeedInventory(), // FeedInventory.dart
//                     if (_selectedChoiceIndex == 2)
